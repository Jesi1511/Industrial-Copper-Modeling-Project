...
st.set_page_config(page_title="Industrial Copper", page_icon="Copper.jpeg", layout="wide", initial_sidebar_state="expanded")

st.write("""
<div style='text-align:center'>
    <h1 style='color:#990099;'>Industrial Copper Modeling Application</h1>
</div>
...
with tab1:    
        ...
        with st.form("my_form"):
            ...
            with col3:               
                st.write( f'<h5 style="color:rgb(153, 0, 153);">NOTE: Min & Max given for reference, you can enter any value</h5>', unsafe_allow_html=True )
...
col1.write('<h6 style="color:rgb(153, 0, 153);">App Created by Jesi</h6>', unsafe_allow_html=True)
image_url = "my.JPG"
col2.image(image_url, width=24)
